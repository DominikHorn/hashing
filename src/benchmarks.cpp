...
void BenchmarkThroughput(const size_t& dataset_size) {
   ...
   if constexpr (sizeof(T) == sizeof(uint64_t)) {
      ...
      BENCHMARK_UNIFORM(hashing::SmallTabulationHash<HASH_64>, dataset);
      BENCHMARK_UNIFORM(hashing::MediumTabulationHash<HASH_64>, dataset);
      BENCHMARK_UNIFORM(hashing::LargeTabulationHash<HASH_64>, dataset);
      ...
      BENCHMARK_UNIFORM(hashing::SmallTabulationHash<HASH_32>, dataset);
      BENCHMARK_UNIFORM(hashing::MediumTabulationHash<HASH_32>, dataset);
   }
}
